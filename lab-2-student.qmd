...
Based on a p-value of 0.0000000000000002, which is a smaller value than the significance level of 0.001, we have sufficient evidence to reject the null hypothesis. This means that we have sufficient evidence that there is a significant difference in at least one rodent species compared to the others. 
